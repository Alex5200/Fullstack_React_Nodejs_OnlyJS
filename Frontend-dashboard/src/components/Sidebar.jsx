      ...
      <div className="w-64 bg-gray-50 h-screen p-4 border-r border-gray-200 flex flex-col">
        ...
        <ul className="space-y-2 flex-1">
          {departments.map(dept => (
            <li key={dept.department_id}>
              <button
                ...
                className="w-full text-left px-3 py-2 rounded-lg hover:bg-blue-50 hover:text-blue-700 transition font-medium"
              >
          ...
          {!ShowCreateForms?(
            <button
            onClick={onCreate}
            className="mt-4 w-full py-2 bg-green-600 text-black font-medium rounded-lg hover:bg-green-700 transition flex items-center justify-center space-x-2"
            >
